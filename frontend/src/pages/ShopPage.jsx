        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full lg:w-1/4 px-4 mb-10 lg:mb-0">
            ...
            <div className="flex items-center p-1.5 mb-10 border border-gray-300 rounded-xl bg-white focus-within:border-red-400 focus-within:ring-1 focus-within:ring-red-400 transition-all">
              <input type="text" placeholder="Search" className="w-full px-4 py-2 outline-none bg-transparent text-gray-700 placeholder-gray-500 font-medium" />
          ...
          <div className="w-full lg:w-3/4 px-4">
            ...
            <div className="flex flex-wrap justify-between items-center mb-8 gap-4">
              <p className="text-gray-500 font-medium text-sm">Showing results</p>
              <div className="relative">
                ...
                <svg className="w-4 h-4 absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
              </div>
            </div>

            {/* 3. HIỂN THỊ DỮ LIỆU */}
            {isLoading ? (
              // Báo hiệu đang tải nếu mạng chậm
              <div className="flex justify-center items-center py-20 w-full">
                <p className="text-gray-500 font-medium text-lg">Đang tải sản phẩm...</p>
              </div>
            ) : (
