...
const ProductPage = () => {
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-5/12 md:pl-8">
            ...
            <p className="text-gray-500 mb-8 leading-relaxed text-sm">
              Written by <strong>{product.author}</strong>.{" "}
              {product.description ||
            ...
            <div className="flex flex-wrap items-center gap-4 mb-10">
              <div className="flex items-center border border-gray-200 rounded">
                ...
                <input
                  ...
                  value={quantity}
                  readOnly
                  className="w-12 text-center text-gray-900 outline-none"
                />
                <button
                  onClick={() =>
              ...
              <button
                ...
                className={`px-6 py-2.5 rounded font-medium transition shadow-sm 
    ${
      product.stock > 0
  ...
  `}
            ...
            <ul className="text-sm text-gray-500 space-y-2">
              <li>
                <span className="text-gray-900 font-semibold mr-2">SKU:</span>{" "}
